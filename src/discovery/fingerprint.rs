...
use pnet::transport::{self, ipv4_packet_iter, TransportChannelType, TransportProtocol, TransportReceiver, TransportSender};
...
fn probe_port_blocking(target: Ipv4Addr, port: u16, src_ip: Ipv4Addr, verbose: bool) -> Option<(u8, u16, Vec<u8>)> {
...
pub async fn probe_syn(target: Ipv4Addr, verbose: bool) -> Option<FingerprintResult> {
